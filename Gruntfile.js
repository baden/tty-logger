	...
	grunt.initConfig({
		...
		copy: {
			package: {
				files: [
					{
						src: 'build/releases/TTY-Logger/TTY-Logger.nw',
						dest: 'build/releases/TTY-Logger/linux32/TTY-Logger/package.nw',
						flatten: true
					},{
						src: 'build/releases/TTY-LoggerTTY-Logger.nw',
						dest: 'build/releases/TTY-Logger/linux64/TTY-Logger/package.nw',
						flatten: true
					}
				]
			}
